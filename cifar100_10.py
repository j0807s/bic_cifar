...
class Cifar100:
    ...
    def initialize(self):
        ...
        assert len(train_groups[0]) == 4500
        assert len(train_groups[1]) == 4500
        assert len(train_groups[2]) == 4500
        assert len(train_groups[3]) == 4500
        assert len(train_groups[4]) == 4500

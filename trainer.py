...
class Trainer:
    def __init__(self, total_cls):
        ...
        self.bias_layers=[self.bias_layer1, self.bias_layer2, self.bias_layer3, self.bias_layer4, self.bias_layer5,
                ...
                self.bias_layer11, self.bias_layer12, self.bias_layer13, self.bias_layer14, self.bias_layer15,
                self.bias_layer16, self.bias_layer17, self.bias_layer18, self.bias_layer19, self.bias_layer20]
    ...
    def bias_forward(self, input):
        ...
        out11 = self.bias_layer11(in11)
        out12 = self.bias_layer12(in12)
        out13 = self.bias_layer13(in13)
        out14 = self.bias_layer14(in14)
        out15 = self.bias_layer15(in15)
        out16 = self.bias_layer16(in16)
        out17 = self.bias_layer17(in17)
        out18 = self.bias_layer18(in18)
        out19 = self.bias_layer19(in19)
        out20 = self.bias_layer20(in20)
        return torch.cat([out1, out2, out3, out4, out5, out6, out7, out8, out9, out10, 
            out11, out12, out13, out14, out15, out16, out17, out18, out19, out20], dim = 1)
